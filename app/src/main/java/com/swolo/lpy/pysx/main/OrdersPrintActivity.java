...
public class OrdersPrintActivity extends BaseActivity implements MainContract.OrdersView {
    ...
    private void updateList() {
        ...
        if (this.ordersList.size() > 0) {
            ...
            ActivityUtil.goBackWithResult(OrdersPrintActivity.this, 1, null);
...
//        final Orders orders1 = orders;
        ...
        threadPool.addTask(new Runnable() {
            ...
            public void run() {
                ...
                if (DeviceConnFactoryManager.getDeviceConnFactoryManagers()[id].getCurrentPrinterCommand() == PrinterCommand.TSC) { // biaoqian
            ...
            switch (msg.what) {
                case CONN_STATE_DISCONN:
                    if (DeviceConnFactoryManager.getDeviceConnFactoryManagers()[id] != null || !DeviceConnFactoryManager.getDeviceConnFactoryManagers()[id].getConnState()) {
                        ...
                        Utils.toast(OrdersPrintActivity.this, getString(R.string.str_disconnect_success));
                    }
                    break;
                case PRINTER_COMMAND_ERROR:
                    Utils.toast(OrdersPrintActivity.this, getString(R.string.str_choice_printer_command));
                    break;
                case CONN_PRINTER:
                    Utils.toast(OrdersPrintActivity.this, getString(R.string.str_cann_printer));
                    break;
